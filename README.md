...
>>For example, if the file you want to tokenize is on the desktop with the filename "~/Desktop/1.txt," and you want the tokenized results to be output to the desktop with the filename "~/Desktop/2.txt," the command would be:    
>>>>**python3 NyimaTashi.py ~/Desktop/1.txt ~/Desktop/2.txt**
